...
class Translator(nodes.NodeVisitor):
    ...
    def visit_docinfo_item(self, node, name) -> NoReturn:
        if name == 'author':
    ...
    def visit_header(self, node) -> NoReturn:
    ...
    def visit_target(self, node) -> NoReturn:
    ...
    def unimplemented_visit(self, node) -> NoReturn:
