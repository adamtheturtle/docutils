...
class Writer(writers.Writer):
    ...
    def write_zip_str(
            self, zfile, name, bytes, compress_type=zipfile.ZIP_DEFLATED) -> None:
...
class ODFTranslator(nodes.GenericNodeVisitor):
    ...
    def create_custom_headfoot(
            self, parent, text, style_name, automatic_styles) -> None:
    ...
    def visit_caption(self, node) -> NoReturn:
    ...
    def visit_term(self, node) -> NoReturn:
    ...
    def visit_description(self, node) -> NoReturn:
        el = self.append_child('table:table-cell', attrib={
    ...
    def visit_raw(self, node) -> NoReturn:
    ...
    def visit_substitution_definition(self, node) -> NoReturn:
        raise nodes.SkipChildren()
    ...
    def visit_title_reference(self, node) -> NoReturn:
