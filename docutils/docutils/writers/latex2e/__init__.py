...
class Table:
    ...
    def get_column_width(self) -> Optional[str]:
    ...
    def get_multicolumn_width(self, start, len_) -> Optional[str]:
...
class LaTeXTranslator(nodes.NodeVisitor):
    ...
    def visit_comment(self, node) -> NoReturn:
        if not isinstance(node.parent, nodes.compound):
            self.out.append('\n')
    ...
    def visit_math(self, node, math_env='$') -> NoReturn:
        """math role"""
        self.visit_inline(node)
