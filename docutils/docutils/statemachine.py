...
class StateMachine:
    ...
    def is_next_line_blank(self) -> Optional[int]:
    ...
    def add_state(self, state_class) -> None:
        """
...
class State:
    ...
    def add_transitions(self, names, transitions) -> None:
        """
    ...
    def add_transition(self, name, transition) -> None:
        """
    ...
    def remove_transition(self, name) -> None:
        """
...
class ViewList:
    ...
    def insert(self, i, item, source=None, offset=0) -> None:
        if source is None:
            if not isinstance(item, ViewList):
